 ...
 * @license Apache-2.0
 * @since 3.0.0
 */class h{constructor(e,t={}){this.types=[...r.MIDI_SYSTEM_MESSAGES.keys,...r.MIDI_CHANNEL_MESSAGES.keys],console.log(this.types),this.channels=t.channels,Array.isArray(e)||(e=[e]),t.types&&!Array.isArray(t.types)&&(t.types=[t.types]),t.channels&&!Array.isArray(t.channels)&&(t.channels=[t.channels]),u.validation&&(e.forEach(e=>{if(!(e instanceof o))throw new TypeError("Destinations must be of type 'Output'.")}),t.types.forEach(e=>{if(!r.MIDI_SYSTEM_MESSAGES.hasOwnProperty(e)&&!r.MIDI_CHANNEL_MESSAGES.hasOwnProperty(e))throw new TypeError("Type must be a valid message type.")})),this.destinations=e,this.suspended=!1}forward(e){this.suspended||this.types&&!this.types.includes(e.type)||this.channels&&e.channel&&!this.channels.includes(e.channel)||this.destinations.forEach(t=>t.send(e))}}
/**
