 ...
 * @since 3.0.0
 */
class a extends e{constructor(e,t){super(),this._input=e,this._number=t,this._octaveOffset=0,this._nrpnBuffer=[],this._rpnBuffer=[],this.parameterNumberEventsEnabled=!0}destroy(){this._input=null,this._number=null,this._octaveOffset=0,this._nrpnBuffer=[],this.parameterNumberEventsEnabled=!1,this.removeListener()}_processMidiMessageEvent(e){const t=Object.assign({},e);t.target=this,t.type="midimessage",this.emit(t.type,t),this._parseEventForStandardMessages(t)}_parseEventForStandardMessages(e){const t=Object.assign({},e);t.type=t.message.type||"unknownmidimessage";const a=e.message.dataBytes[0],s=e.message.dataBytes[1];"noteoff"===t.type||"noteon"===t.type&&0===s?(t.note=new n(r.offsetNumber(a,this.octaveOffset+this.input.octaveOffset+c.octaveOffset),{rawAttack:0,rawRelease:s}),t.value=r.toNormalized(s),t.rawValue=s,t.velocity=t.note.release,t.rawVelocity=t.note.rawRelease):"noteon"===t.type?(t.note=new n(r.offsetNumber(a,this.octaveOffset+this.input.octaveOffset+c.octaveOffset),{rawAttack:s}),t.value=r.toNormalized(s),t.rawValue=s,t.velocity=t.note.attack,t.rawVelocity=t.note.rawAttack):"keyaftertouch"===t.type?(t.identifier=r.toNoteIdentifier(a,c.octaveOffset+this.input.octaveOffset+this.octaveOffset),t.key=r.toNoteNumber(t.identifier),t.rawKey=a,t.value=r.toNormalized(s),t.rawValue=s,t.note=new n(r.offsetNumber(a,this.octaveOffset+this.input.octaveOffset+c.octaveOffset))):"controlchange"===t.type?(t.controller={number:a,name:this.getCcNameByNumber(a)},t.value=r.toNormalized(s),t.rawValue=s,t.message.dataBytes[0]>=120&&this._parseChannelModeMessage(t),this.parameterNumberEventsEnabled&&this.isRpnOrNrpnController(t.message.dataBytes[0])&&this._parseEventForParameterNumber(t)):"programchange"===t.type?(t.value=a+1,t.rawValue=a):"channelaftertouch"===t.type?(t.value=r.toNormalized(a),t.rawValue=a):"pitchbend"===t.type?(t.value=((s<<7)+a-8192)/8192,t.rawValue=(s<<7)+a):t.type="unknownmessage",this.emit(t.type,t)}_parseChannelModeMessage(e){const t=Object.assign({},e);t.type=t.controller.name,"localcontrol"===t.type&&(t.value=127===t.message.data[2]),"omnimodeon"===t.type?(t.type="omnimode",t.value=!0):"omnimodeoff"===t.type&&(t.type="omnimode",t.value=!1),"monomodeon"===t.type?(t.type="monomode",t.value=!0):"polymodeon"===t.type&&(t.type="monomode",t.value=!1),this.emit(t.type,t)}_parseEventForParameterNumber(e){const t=e.message.dataBytes[0],n=e.message.dataBytes[1],r=c.MIDI_CONTROL_CHANGE_MESSAGES;t===r.nonregisteredparameterfine||t===r.registeredparameterfine?(this._nrpnBuffer=[],this._rpnBuffer=[],t===r.nonregisteredparameterfine?this._nrpnBuffer=[e.message]:127!==n&&(this._rpnBuffer=[e.message])):t===r.nonregisteredparametercoarse||t===r.registeredparametercoarse?t===r.nonregisteredparametercoarse?(this._rpnBuffer=[],1===this._nrpnBuffer.length?this._nrpnBuffer.push(e.message):this._nrpnBuffer=[]):(this._nrpnBuffer=[],1===this._rpnBuffer.length&&127!==n?this._rpnBuffer.push(e.message):this._rpnBuffer=[]):t!==r.dataentrycoarse&&t!==r.dataentryfine&&t!==r.databuttonincrement&&t!==r.databuttondecrement||(2===this._rpnBuffer.length?this._dispatchParameterNumberEvent("rpn",this._rpnBuffer[0].dataBytes[1],this._rpnBuffer[1].dataBytes[1],e):2===this._nrpnBuffer.length?this._dispatchParameterNumberEvent("nrpn",this._nrpnBuffer[0].dataBytes[1],this._nrpnBuffer[1].dataBytes[1],e):(this._nrpnBuffer=[],this._rpnBuffer=[]))}isRpnOrNrpnController(e){return e===c.MIDI_CONTROL_CHANGE_MESSAGES.dataentrycoarse||e===c.MIDI_CONTROL_CHANGE_MESSAGES.dataentryfine||e===c.MIDI_CONTROL_CHANGE_MESSAGES.databuttonincrement||e===c.MIDI_CONTROL_CHANGE_MESSAGES.databuttondecrement||e===c.MIDI_CONTROL_CHANGE_MESSAGES.nonregisteredparametercoarse||e===c.MIDI_CONTROL_CHANGE_MESSAGES.nonregisteredparameterfine||e===c.MIDI_CONTROL_CHANGE_MESSAGES.registeredparametercoarse||e===c.MIDI_CONTROL_CHANGE_MESSAGES.registeredparameterfine}_dispatchParameterNumberEvent(e,t,n,a){const s={target:a.target,timestamp:a.timestamp,parameterMsb:t,parameterLsb:n,value:r.toNormalized(a.message.dataBytes[1]),rawValue:a.message.dataBytes[1],type:"rpn"===e?"rpn":"nrpn"};s.type+=r.getPropertyByValue(c.MIDI_CONTROL_CHANGE_MESSAGES,a.message.dataBytes[0]),s.parameter="rpn"===e?Object.keys(c.MIDI_REGISTERED_PARAMETERS).find(e=>c.MIDI_REGISTERED_PARAMETERS[e][0]===t&&c.MIDI_REGISTERED_PARAMETERS[e][1]===n):(t<<7)+n,this.emit(s.type,s)}getChannelModeByNumber(e){if(c.validation&&(e=Math.floor(e)),!(e>=120&&e<=127))return!1;for(let t in c.MIDI_CHANNEL_MODE_MESSAGES)if(c.MIDI_CHANNEL_MODE_MESSAGES.hasOwnProperty(t)&&e===c.MIDI_CHANNEL_MODE_MESSAGES[t])return t;return!1}getCcNameByNumber(e){if(c.validation&&!((e=parseInt(e))>=0&&e<=127))throw new RangeError("Invalid control change number.");return r.getPropertyByValue(c.MIDI_CONTROL_CHANGE_MESSAGES,e)}get octaveOffset(){return this._octaveOffset}set octaveOffset(e){if(this.validation&&(e=parseInt(e),isNaN(e)))throw new TypeError("The 'octaveOffset' property must be an integer.");this._octaveOffset=e}get input(){return this._input}get number(){return this._number}get nrpnEventsEnabled(){return this.parameterNumberEventsEnabled}set nrpnEventsEnabled(e){this.validation&&(e=!!e),this.parameterNumberEventsEnabled=e}}
/**
