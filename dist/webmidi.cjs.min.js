 ...
 * @license Apache-2.0
 * @since 3.0.0
 */class h{constructor(e,t={}){Array.isArray(e)||(e=[e]),t.types&&!Array.isArray(t.types)&&(t.types=[t.types]),t.channels&&!Array.isArray(t.channels)&&(t.channels=[t.channels]),u.validation&&(e.forEach(e=>{if(!(e instanceof o))throw new TypeError("Destinations must be of type 'Output'.")}),t.types.forEach(e=>{if(!a.getPropertyByValue(r.MIDI_SYSTEM_MESSAGES,e)&&!a.getPropertyByValue(r.MIDI_CHANNEL_MESSAGES,e))throw console.log(e,a.getPropertyByValue(r.MIDI_SYSTEM_MESSAGES,e),a.getPropertyByValue(r.MIDI_CHANNEL_MESSAGES,e)),new TypeError("Type must be a valid message type.")})),this.destinations=e,this.types=t.types,this.channels=t.channels,this.suspended=!1}forward(e){this.suspended||this.types&&!this.types.includes(e.type)||this.channels&&e.channel&&!this.channels.includes(e.channel)||this.destinations.forEach(t=>t.send(e))}}
/**
