(function(scope) {
   ...
   *
   * @param [filters={}]
   * @param [filters.device=all] {String|Array|"all"} The id of the MIDI device to listen on. The
   ...
   *                                                  callback function.
   * @param [filters.channel=all] {uint|Array|"all"}  The MIDI channel to listen on (between 1 and
   ...
   * @param [filters.device=all] {String|Array|"all"}   The id of the MIDI device to check on (as
   *                                                    reported by `WebMidi.inputs`).
   * @param [filters.channel=all] {uint|Array|"all"}    The MIDI channel to check on. It can be a
   ...
   * @param listener {Function}         The callback function to check for.
   * @param [filters={}] {Object}
   * @param [filters.device=all] {String|"all"}  The MIDI channel to check on. It can be a uint
   * @param [filters.channel=all] {uint|"all"}  The MIDI channel to check on. It can be a uint
