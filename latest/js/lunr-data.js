window.lunrData = {
    ...
    "documentStore": {
      "store": {
        ...
        "WebMidi.html": [
          ...
          "webmidi.input",
          "webmidi.inputs[0].addlistener(\"pitchbend",
          "webmidi.output",
  ...
  "store": {
    "index.html": {
      ...
      "name": "WebMidi.js",
      "tags": "index",
      "summary": "A JavaScript library to you tame the Web MIDI API",
      "description": "",
      "body": ""
    },
    "global.html": {
    ...
    "Input.html": {
      ...
      "tags": "Input",
      "summary": "",
      "description": "The Input object represents a MIDI input port on the host system. This object is created by the MIDI subsystem and cannot be instantiated directly. You will find all available Input objects in the WebMidi.inputs array.",
      "body": ""
    },
    "Output.html": {
      "id": "Output.html",
      ...
      "tags": "Output",
      "summary": "",
      "description": "The Output object represents a MIDI output port on the host system. This object is created by the MIDI subsystem and cannot be instantiated directly. You will find all available Output objects in the WebMidi.outputs array.",
      "body": ""
    },
    "WebMidi.html": {
      "id": "WebMidi.html",
