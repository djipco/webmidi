...
export default [
  ...
  {
    path: '/webmidi/__docusaurus/debug',
    component: ComponentCreator('/webmidi/__docusaurus/debug','d91'),
    exact: true
  },
  {
    path: '/webmidi/__docusaurus/debug/config',
    component: ComponentCreator('/webmidi/__docusaurus/debug/config','9da'),
    exact: true
  },
  {
    path: '/webmidi/__docusaurus/debug/content',
    component: ComponentCreator('/webmidi/__docusaurus/debug/content','883'),
    exact: true
  },
  {
    path: '/webmidi/__docusaurus/debug/globalData',
    component: ComponentCreator('/webmidi/__docusaurus/debug/globalData','13a'),
    exact: true
  },
  {
    path: '/webmidi/__docusaurus/debug/metadata',
    component: ComponentCreator('/webmidi/__docusaurus/debug/metadata','af2'),
    exact: true
  },
  {
    path: '/webmidi/__docusaurus/debug/registry',
    component: ComponentCreator('/webmidi/__docusaurus/debug/registry','f6d'),
    exact: true
  },
  {
    path: '/webmidi/__docusaurus/debug/routes',
    component: ComponentCreator('/webmidi/__docusaurus/debug/routes','07b'),
    exact: true
  },
  {
    path: '/webmidi/api/',
