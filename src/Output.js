...
export class Output extends EventEmitter {
   ...
   */
  selectRegisteredParameter(parameter, channel, options = {}) {

    WebMidi.sanitizeChannels(channel).forEach(ch => {
      this.channels[ch].selectRegisteredParameter(parameter, options);
    });
   ...
   * will be carried out as soon as possible.
   */
  selectNonRegisteredParameter(parameter, channel, options = {}) {

    WebMidi.sanitizeChannels(channel).forEach(ch => {
      this.channels[ch].selectNonRegisteredParameter(parameter, options);
    });
   ...
   * will be carried out as soon as possible.
   */
  deselectRegisteredParameter(channel, options= {}) {

    WebMidi.sanitizeChannels(channel).forEach(ch => {
      this.channels[ch].deselectRegisteredParameter(options);
    });
