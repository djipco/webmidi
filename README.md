...
The [API for WebMidi.js](https://djipco.github.io/webmidi/latest/classes/WebMidi.html) is fully 
...
**[API Reference](https://djipco.github.io/webmidi/latest/classes/WebMidi.html)**. You can also find 
the API reference in portable format inside the `docs` folder.

By the way, legacy 
[documentation for version 1.0.0-beta.15](https://djipco.github.io/webmidi/v1.0.0-beta.15/classes/WebMidi.html)
