...
**Fires**: [`InputChannel#event:midimessage`](InputChannel#event:midimessage), [`InputChannel#event:noteoff`](InputChannel#event:noteoff), [`InputChannel#event:noteon`](InputChannel#event:noteon), [`InputChannel#event:keyaftertouch`](InputChannel#event:keyaftertouch), [`InputChannel#event:controlchange`](InputChannel#event:controlchange), [`InputChannel#event:programchange`](InputChannel#event:programchange), [`InputChannel#event:channelaftertouch`](InputChannel#event:channelaftertouch), [`InputChannel#event:pitchbend`](InputChannel#event:pitchbend), [`InputChannel#event:allnotesoff`](InputChannel#event:allnotesoff), [`InputChannel#event:allsoundoff`](InputChannel#event:allsoundoff), [`InputChannel#event:localcontrol`](InputChannel#event:localcontrol), [`InputChannel#event:monomode`](InputChannel#event:monomode), [`InputChannel#event:omnimode`](InputChannel#event:omnimode), [`InputChannel#event:resetallcontrollers`](InputChannel#event:resetallcontrollers), [`InputChannel#event:nrpn-dataentrycoarse`](InputChannel#event:nrpn-dataentrycoarse), [`InputChannel#event:nrpn-dataentryfine`](InputChannel#event:nrpn-dataentryfine), [`InputChannel#event:nrpn-databuttonincrement`](InputChannel#event:nrpn-databuttonincrement), [`InputChannel#event:nrpn-databuttondecrement`](InputChannel#event:nrpn-databuttondecrement), [`InputChannel#event:rpn-dataentrycoarse`](InputChannel#event:rpn-dataentrycoarse), [`InputChannel#event:rpn-dataentryfine`](InputChannel#event:rpn-dataentryfine), [`InputChannel#event:rpn-databuttonincrement`](InputChannel#event:rpn-databuttonincrement), [`InputChannel#event:rpn-databuttondecrement`](InputChannel#event:rpn-databuttondecrement)
