...
**Fires**: [`event:midimessage`](InputChannel#event:midimessage), [`event:noteoff`](InputChannel#event:noteoff), [`event:noteon`](InputChannel#event:noteon), [`event:keyaftertouch`](InputChannel#event:keyaftertouch), [`event:controlchange`](InputChannel#event:controlchange), [`event:programchange`](InputChannel#event:programchange), [`event:channelaftertouch`](InputChannel#event:channelaftertouch), [`event:pitchbend`](InputChannel#event:pitchbend), [`event:allnotesoff`](InputChannel#event:allnotesoff), [`event:allsoundoff`](InputChannel#event:allsoundoff), [`event:localcontrol`](InputChannel#event:localcontrol), [`event:monomode`](InputChannel#event:monomode), [`event:omnimode`](InputChannel#event:omnimode), [`event:resetallcontrollers`](InputChannel#event:resetallcontrollers), [`event:nrpn-dataentrycoarse`](InputChannel#event:nrpn-dataentrycoarse), [`event:nrpn-dataentryfine`](InputChannel#event:nrpn-dataentryfine), [`event:nrpn-databuttonincrement`](InputChannel#event:nrpn-databuttonincrement), [`event:nrpn-databuttondecrement`](InputChannel#event:nrpn-databuttondecrement), [`event:rpn-dataentrycoarse`](InputChannel#event:rpn-dataentrycoarse), [`event:rpn-dataentryfine`](InputChannel#event:rpn-dataentryfine), [`event:rpn-databuttonincrement`](InputChannel#event:rpn-databuttonincrement), [`event:rpn-databuttondecrement`](InputChannel#event:rpn-databuttondecrement)
