...
| ------------ | ------------ | ------------ | ------------ |
  |**`number`**<br />mandatory|number||An integer representing the control change message|
...
| Parameter    | Type         | Default      | Description  |
| ------------ | ------------ | ------------ | ------------ |
  |**`number`**<br />mandatory|number||An integer representing the channel mode message.|
