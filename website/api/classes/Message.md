...
### `.dataBytes` : <code>Array.&lt;number&gt;</code>
...
### `.isChannelMessage` : <code>boolean</code>
...
### `.isSystemMessage` : <code>boolean</code>
...
### `.manufacturerId` : <code>Array.&lt;number&gt;</code>
...
### `.rawDataBytes` : <code>Uint8Array</code>
