...
By the way, if you call the enable() method while WebMidi.js is already enabled, the callback
function will be executed (if any), the promise will resolve but the events
