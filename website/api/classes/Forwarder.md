...
### `Constructor`
  ...
  **Parameters**
  ...
  | ------------ | ------------ | ------------ | ------------ |
    ...
    |[**`options.channel`**] | number<br /> |prout|A MIDI channel number or an array of channel numbers that the message must match in order to be forwarded. If this option is not specified, messages from all channels will be forwarded.|
