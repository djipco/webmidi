...
|[ **`options.channels`** ]  : number|<br />Default: &quot;all&quot;|The MIDI channel number (between `1` and `16`) or an array of channel numbers to use. The special value `"all"` can also be used to use all channels (default).|
...
|[ **`options`** ]  : Object|<br />Default: {}||
|[ **`options.channels`** ]  : number|<br />Default: &quot;all&quot;|The MIDI channel number (between `1` and `16`) or an array of channel numbers to play the note on. The special value `"all"` can also be used to use all channels (default).|
|[ **`options.duration`** ]  : number|<br />Default: |The number of milliseconds (integer) after which a **note off** message will be scheduled. If left undefined, only a **note on** message is sent.|
|[ **`options.rawValue`** ]  : boolean|<br />Default: false|Controls whether the attack and release velocities are set using integers between `0` and `127` (`true`) or a decimal number between `0` and `1` (`false`, default).|
...
|[ **`options.time`** ]  : number|<br />Default: |If `time` is a string prefixed with `"+"` and followed by a number, the message will be delayed by that many milliseconds. If the value is a number (DOMHighResTimeStamp), the operation will be scheduled for that time. If `time` is omitted, or in the past, the operation will be carried out as soon as possible.|
|[ **`options.attack`** ]  : number|<br />Default: 0.5|The attack velocity to use when playing the note (between `0` and `1`). If the `rawValue` option is `true`, the value should be specified as an integer between `0` and `127`. An invalid velocity value will silently trigger the default of `0.5`.|
...
|[ **`value`** ]  : number|<br />Default: 0|The value to send (0-127).|
|[ **`options`** ]  : Object|<br />Default: {}||
|[ **`options.channels`** ]  : number|<br />Default: &quot;all&quot;|The MIDI channel number (between `1` and `16`) or an array of channel numbers to use. The special value `"all"` can also be used to use all channels (default).|
|[ **`options.time`** ]  : number|<br />Default: |If `time` is a string prefixed with `"+"` and followed by a number, the message will be delayed by that many milliseconds. If the value is a number (DOMHighResTimeStamp), the operation will be scheduled for that time. If `time` is omitted, or in the past, the operation will be carried out as soon as possible.|
...
|[ **`options`** ]  : Object|<br />Default: {}||
|[ **`options.channels`** ]  : number|<br />Default: &quot;all&quot;|The MIDI channel number (between `1` and `16`) or an array of channel numbers to use. The special value `"all"` can also be used to use all channels (default).|
|[ **`options.rawValue`** ]  : boolean|<br />Default: false|Controls whether the release velocity is set using integers between `0` and `127` (`true`) or a decimal number between `0` and `1` (`false`, default).|
|[ **`options.time`** ]  : number|<br />Default: |If `time` is a string prefixed with `"+"` and followed by a number, the message will be delayed by that many milliseconds. If the value is a number (DOMHighResTimeStamp), the operation will be scheduled for that time. If `time` is omitted, or in the past, the operation will be carried out as soon as possible.|
|[ **`options.release`** ]  : number|<br />Default: 0.5|The velocity at which to release the note (between `0` and `1`). If the `rawValue` option is `true`, the value should be specified as an integer between `0` and `127`. An invalid velocity value will silently trigger the default of `0.5`.|
...
|[ **`options`** ]  : Object|<br />Default: {}||
|[ **`options.channels`** ]  : number|<br />Default: &quot;all&quot;|The MIDI channel number (between `1` and `16`) or an array of channel numbers to use. The special value `"all"` can also be used to use all channels (default).|
|[ **`options.rawValue`** ]  : boolean|<br />Default: false|Controls whether the attack velocity is set using integers between `0` and `127` (`true`) or a decimal number between `0` and `1` (`false`, default).|
|[ **`options.time`** ]  : number|<br />Default: |If `time` is a string prefixed with `"+"` and followed by a number, the message will be delayed by that many milliseconds. If the value is a number (DOMHighResTimeStamp), the operation will be scheduled for that time. If `time` is omitted, or in the past, the operation will be carried out as soon as possible.|
|[ **`options.attack`** ]  : number|<br />Default: 0.5|The velocity at which to play the note (between `0` and `1`). If the `rawValue` option is `true`, the value should be specified as an integer between `0` and `127`. An invalid velocity value will silently trigger the default of `0.5`.|
...
| Parameter    | Default      | Description  |
| ------------ | ------------ | ------------ |
|**`manufacturer`**  : number|<br />Default: |An unsigned integer or an array of three unsigned integers between 0 and 127 that identify the targeted manufacturer. The *MIDI Manufacturers Association* maintains a full list of [Manufacturer ID Numbers](https://www.midi.org/specifications-old/item/manufacturer-id-numbers) .|
|[ **`data`** ]  : Array.&lt;number&gt;|<br />Default: []|A Uint8Array or an array of unsigned integers between 0 and 127. This is the data you wish to transfer.|
|[ **`options`** ]  : Object|<br />Default: {}||
|[ **`options.time`** ]  : number|<br />Default: |If `time` is a string prefixed with `"+"` and followed by a number, the message will be delayed by that many milliseconds. If the value is a number (DOMHighResTimeStamp), the operation will be scheduled for that time. If `time` is omitted, or in the past, the operation will be carried out as soon as possible.|
...
| Parameter    | Default      | Description  |
| ------------ | ------------ | ------------ |
|**`value`**  : number|<br />Default: |The quarter frame message content (integer between 0 and 127).|
|[ **`options`** ]  : Object|<br />Default: {}||
|[ **`options.time`** ]  : number|<br />Default: |If `time` is a string prefixed with `"+"` and followed by a number, the message will be delayed by that many milliseconds. If the value is a number (DOMHighResTimeStamp), the operation will be scheduled for that time. If `time` is omitted, or in the past, the operation will be carried out as soon as possible.|
...
| Parameter    | Default      | Description  |
| ------------ | ------------ | ------------ |
|[ **`pressure`** ]  : number|<br />Default: 0.5|The pressure level (between 0 and 1). An invalid pressure value will silently trigger the default behaviour. If the `rawValue` option is set to `true`, the pressure can be defined by using an integer between 0 and 127.|
|[ **`options`** ]  : Object|<br />Default: {}||
|[ **`options.channels`** ]  : number|<br />Default: &quot;all&quot;|The MIDI channel number (between `1` and `16`) or an array of channel numbers to use. The special value `"all"` can also be used to use all channels (default).|
...
| Parameter    | Default      | Description  |
| ------------ | ------------ | ------------ |
|[ **`semitones`** ]  : number|<br />Default: 0|The desired adjustment value in semitones (integer between 0 and 127).|
...
| Parameter    | Default      | Description  |
| ------------ | ------------ | ------------ |
|[ **`state`** ]  : boolean|<br />Default: |Whether to activate OMNI mode (`true`) or not (`false`).|
|[ **`options`** ]  : Object|<br />Default: {}||
|[ **`options.channels`** ]  : number|<br />Default: &quot;all&quot;|The MIDI channel number (between `1` and `16`) or an array of channel numbers to use. The special value `"all"` can also be used to use all channels (default).|
|[ **`options.time`** ]  : number|<br />Default: |If `time` is a string prefixed with `"+"` and followed by a number, the message will be delayed by that many milliseconds. If the value is a number (DOMHighResTimeStamp), the operation will be scheduled for that time. If `time` is omitted, or in the past, the operation will be carried out as soon as possible.|
...
| Parameter    | Default      | Description  |
| ------------ | ------------ | ------------ |
|**`mode`**  : string|<br />Default: |The mode to use: `"mono"` or `"poly"`.|
|[ **`options`** ]  : Object|<br />Default: {}||
|[ **`options.channels`** ]  : number|<br />Default: &quot;all&quot;|The MIDI channel number (between `1` and `16`) or an array of channel numbers to use. The special value `"all"` can also be used to use all channels (default).|
|[ **`options.time`** ]  : number|<br />Default: |If `time` is a string prefixed with `"+"` and followed by a number, the message will be delayed by that many milliseconds. If the value is a number (DOMHighResTimeStamp), the operation will be scheduled for that time. If `time` is omitted, or in the past, the operation will be carried out as soon as possible.|
...
|[ **`data`** ]  : number|<br />Default: []|A single integer or an array of integers with a maximum length of 2 specifying the desired data.|
|[ **`options`** ]  : Object|<br />Default: {}||
|[ **`options.channels`** ]  : number|<br />Default: &quot;all&quot;|The MIDI channel number (between `1` and `16`) or an array of channel numbers to use. The special value `"all"` can also be used to use all channels (default).|
|[ **`options.time`** ]  : number|<br />Default: |If `time` is a string prefixed with `"+"` and followed by a number, the message will be delayed by that many milliseconds. If the value is a number (DOMHighResTimeStamp), the operation will be scheduled for that time. If `time` is omitted, or in the past, the operation will be carried out as soon as possible.|
...
| Parameter    | Default      | Description  |
| ------------ | ------------ | ------------ |
|**`value`**  : number|<br />Default: |The number of the song to select (integer between 1 and 128).|
|[ **`options`** ]  : Object|<br />Default: {}||
|[ **`options.time`** ]  : number|<br />Default: |If `time` is a string prefixed with `"+"` and followed by a number, the message will be delayed by that many milliseconds. If the value is a number (DOMHighResTimeStamp), the operation will be scheduled for that time. If `time` is omitted, or in the past, the operation will be carried out as soon as possible.|
...
| Parameter    | Default      | Description  |
| ------------ | ------------ | ------------ |
|[ **`value`** ]  : number|<br />Default: 0|The MIDI beat to cue to (integer between 0 and 16383).|
|[ **`options`** ]  : Object|<br />Default: {}||
|[ **`options.time`** ]  : number|<br />Default: |If `time` is a string prefixed with `"+"` and followed by a number, the message will be delayed by that many milliseconds. If the value is a number (DOMHighResTimeStamp), the operation will be scheduled for that time. If `time` is omitted, or in the past, the operation will be carried out as soon as possible.|
