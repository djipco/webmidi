...
| ------------ | ------------ | ------------ |
  ...
  |**`options.channels`** : number|<br />Default: &quot;all&quot;<br />optional|The MIDI channel number (between `1` and `16`) or an array of channel numbers to use. The special value `"all"` can also be used to use all channels (default).|
...
| ------------ | ------------ | ------------ |
  ...
  |**`options`** : Object|<br />Default: {}<br />optional||
  |**`options.channels`** : number|<br />Default: &quot;all&quot;<br />optional|The MIDI channel number (between `1` and `16`) or an array of channel numbers to play the note on. The special value `"all"` can also be used to use all channels (default).|
  |**`options.duration`** : number|<br />Default: <br />optional|The number of milliseconds (integer) after which a **note off** message will be scheduled. If left undefined, only a **note on** message is sent.|
  |**`options.rawValue`** : boolean|<br />Default: false<br />optional|Controls whether the attack and release velocities are set using integers between `0` and `127` (`true`) or a decimal number between `0` and `1` (`false`, default).|
  ...
  |**`options.time`** : number|<br />Default: <br />optional|If `time` is a string prefixed with `"+"` and followed by a number, the message will be delayed by that many milliseconds. If the value is a number (DOMHighResTimeStamp), the operation will be scheduled for that time. If `time` is omitted, or in the past, the operation will be carried out as soon as possible.|
  |**`options.attack`** : number|<br />Default: 0.5<br />optional|The attack velocity to use when playing the note (between `0` and `1`). If the `rawValue` option is `true`, the value should be specified as an integer between `0` and `127`. An invalid velocity value will silently trigger the default of `0.5`.|
...
| ------------ | ------------ | ------------ |
  ...
  |**`value`** : number|<br />Default: <br />optional|The value to send (integer between 0-127).|
  |**`options`** : Object|<br />Default: {}<br />optional||
  |**`options.channels`** : number|<br />Default: &quot;all&quot;<br />optional|The MIDI channel number (between `1` and `16`) or an array of channel numbers to use. The special value `"all"` can also be used to use all channels (default).|
  |**`options.time`** : number|<br />Default: <br />optional|If `time` is a string prefixed with `"+"` and followed by a number, the message will be delayed by that many milliseconds. If the value is a number (DOMHighResTimeStamp), the operation will be scheduled for that time. If `time` is omitted, or in the past, the operation will be carried out as soon as possible.|
...
| ------------ | ------------ | ------------ |
  ...
  |**`value`** : number|<br />Default: 0<br />optional|The value to send (0-127).|
  |**`options`** : Object|<br />Default: {}<br />optional||
  |**`options.channels`** : number|<br />Default: &quot;all&quot;<br />optional|The MIDI channel number (between `1` and `16`) or an array of channel numbers to use. The special value `"all"` can also be used to use all channels (default).|
  |**`options.time`** : number|<br />Default: <br />optional|If `time` is a string prefixed with `"+"` and followed by a number, the message will be delayed by that many milliseconds. If the value is a number (DOMHighResTimeStamp), the operation will be scheduled for that time. If `time` is omitted, or in the past, the operation will be carried out as soon as possible.|
...
| ------------ | ------------ | ------------ |
  ...
  |**`options`** : Object|<br />Default: {}<br />optional||
  |**`options.channels`** : number|<br />Default: &quot;all&quot;<br />optional|The MIDI channel number (between `1` and `16`) or an array of channel numbers to use. The special value `"all"` can also be used to use all channels (default).|
  |**`options.rawValue`** : boolean|<br />Default: false<br />optional|Controls whether the release velocity is set using integers between `0` and `127` (`true`) or a decimal number between `0` and `1` (`false`, default).|
  |**`options.time`** : number|<br />Default: <br />optional|If `time` is a string prefixed with `"+"` and followed by a number, the message will be delayed by that many milliseconds. If the value is a number (DOMHighResTimeStamp), the operation will be scheduled for that time. If `time` is omitted, or in the past, the operation will be carried out as soon as possible.|
  |**`options.release`** : number|<br />Default: 0.5<br />optional|The velocity at which to release the note (between `0` and `1`). If the `rawValue` option is `true`, the value should be specified as an integer between `0` and `127`. An invalid velocity value will silently trigger the default of `0.5`.|
...
| ------------ | ------------ | ------------ |
  ...
  |**`options`** : Object|<br />Default: {}<br />optional||
  |**`options.channels`** : number|<br />Default: &quot;all&quot;<br />optional|The MIDI channel number (between `1` and `16`) or an array of channel numbers to use. The special value `"all"` can also be used to use all channels (default).|
  |**`options.rawValue`** : boolean|<br />Default: false<br />optional|Controls whether the attack velocity is set using integers between `0` and `127` (`true`) or a decimal number between `0` and `1` (`false`, default).|
  |**`options.time`** : number|<br />Default: <br />optional|If `time` is a string prefixed with `"+"` and followed by a number, the message will be delayed by that many milliseconds. If the value is a number (DOMHighResTimeStamp), the operation will be scheduled for that time. If `time` is omitted, or in the past, the operation will be carried out as soon as possible.|
  |**`options.attack`** : number|<br />Default: 0.5<br />optional|The velocity at which to play the note (between `0` and `1`). If the `rawValue` option is `true`, the value should be specified as an integer between `0` and `127`. An invalid velocity value will silently trigger the default of `0.5`.|
...
| Parameter    | Attributes   | Description  |
| ------------ | ------------ | ------------ |
  |**`value`** : number|<br />Default: <br />mandatory|The quarter frame message content (integer between 0 and 127).|
  |**`options`** : Object|<br />Default: {}<br />optional||
  |**`options.time`** : number|<br />Default: <br />optional|If `time` is a string prefixed with `"+"` and followed by a number, the message will be delayed by that many milliseconds. If the value is a number (DOMHighResTimeStamp), the operation will be scheduled for that time. If `time` is omitted, or in the past, the operation will be carried out as soon as possible.|
...
| Parameter    | Attributes   | Description  |
| ------------ | ------------ | ------------ |
  |**`pressure`** : number|<br />Default: 0.5<br />optional|The pressure level (between 0 and 1). An invalid pressure value will silently trigger the default behaviour. If the `rawValue` option is set to `true`, the pressure can be defined by using an integer between 0 and 127.|
  |**`options`** : Object|<br />Default: {}<br />optional||
  |**`options.channels`** : number|<br />Default: &quot;all&quot;<br />optional|The MIDI channel number (between `1` and `16`) or an array of channel numbers to use. The special value `"all"` can also be used to use all channels (default).|
...
| Parameter    | Attributes   | Description  |
| ------------ | ------------ | ------------ |
  |**`semitones`** : number|<br />Default: 0<br />optional|The desired adjustment value in semitones (integer between 0 and 127).|
...
| Parameter    | Attributes   | Description  |
| ------------ | ------------ | ------------ |
  |**`state`** : boolean|<br />Default: <br />optional|Whether to activate OMNI mode (`true`) or not (`false`).|
  |**`options`** : Object|<br />Default: {}<br />optional||
  |**`options.channels`** : number|<br />Default: &quot;all&quot;<br />optional|The MIDI channel number (between `1` and `16`) or an array of channel numbers to use. The special value `"all"` can also be used to use all channels (default).|
  |**`options.time`** : number|<br />Default: <br />optional|If `time` is a string prefixed with `"+"` and followed by a number, the message will be delayed by that many milliseconds. If the value is a number (DOMHighResTimeStamp), the operation will be scheduled for that time. If `time` is omitted, or in the past, the operation will be carried out as soon as possible.|
...
| Parameter    | Attributes   | Description  |
| ------------ | ------------ | ------------ |
  |**`mode`** : string|<br />Default: <br />mandatory|The mode to use: `"mono"` or `"poly"`.|
  |**`options`** : Object|<br />Default: {}<br />optional||
  |**`options.channels`** : number|<br />Default: &quot;all&quot;<br />optional|The MIDI channel number (between `1` and `16`) or an array of channel numbers to use. The special value `"all"` can also be used to use all channels (default).|
  |**`options.time`** : number|<br />Default: <br />optional|If `time` is a string prefixed with `"+"` and followed by a number, the message will be delayed by that many milliseconds. If the value is a number (DOMHighResTimeStamp), the operation will be scheduled for that time. If `time` is omitted, or in the past, the operation will be carried out as soon as possible.|
...
| ------------ | ------------ | ------------ |
  ...
  |**`data`** : number|<br />Default: []<br />optional|A single integer or an array of integers with a maximum length of 2 specifying the desired data.|
  |**`options`** : Object|<br />Default: {}<br />optional||
  |**`options.channels`** : number|<br />Default: &quot;all&quot;<br />optional|The MIDI channel number (between `1` and `16`) or an array of channel numbers to use. The special value `"all"` can also be used to use all channels (default).|
  |**`options.time`** : number|<br />Default: <br />optional|If `time` is a string prefixed with `"+"` and followed by a number, the message will be delayed by that many milliseconds. If the value is a number (DOMHighResTimeStamp), the operation will be scheduled for that time. If `time` is omitted, or in the past, the operation will be carried out as soon as possible.|
...
| Parameter    | Attributes   | Description  |
| ------------ | ------------ | ------------ |
  |**`value`** : number|<br />Default: <br />mandatory|The number of the song to select (integer between 1 and 128).|
  |**`options`** : Object|<br />Default: {}<br />optional||
  |**`options.time`** : number|<br />Default: <br />optional|If `time` is a string prefixed with `"+"` and followed by a number, the message will be delayed by that many milliseconds. If the value is a number (DOMHighResTimeStamp), the operation will be scheduled for that time. If `time` is omitted, or in the past, the operation will be carried out as soon as possible.|
...
| Parameter    | Attributes   | Description  |
| ------------ | ------------ | ------------ |
  |**`value`** : number|<br />Default: 0<br />optional|The MIDI beat to cue to (integer between 0 and 16383).|
  |**`options`** : Object|<br />Default: {}<br />optional||
  |**`options.time`** : number|<br />Default: <br />optional|If `time` is a string prefixed with `"+"` and followed by a number, the message will be delayed by that many milliseconds. If the value is a number (DOMHighResTimeStamp), the operation will be scheduled for that time. If `time` is omitted, or in the past, the operation will be carried out as soon as possible.|
