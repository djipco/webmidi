...
| ------------ | ------------ | ------------ |
  |**`parameter`**|Type: String<br />Default: <br />mandatory|A string identifying the parameter"s name (see above) or a two-position array specifying the two control bytes (0x65, 0x64) that identify the registered parameter.|
  |**`options`**|Type: Object<br />Default: {}<br />optional||
  |**`options.channels`**|Type: number<br />Default: &quot;all&quot;<br />optional|The MIDI channel number (between `1` and `16`) or an array of channel numbers to use. The special value `"all"` can also be used to use all channels (default).|
  |**`options.time`**|Type: number<br />Default: <br />optional|If `time` is a string prefixed with `"+"` and followed by a number, the message will be delayed by that many milliseconds. If the value is a number (DOMHighResTimeStamp), the operation will be scheduled for that time. If `time` is omitted, or in the past, the operation will be carried out as soon as possible.|
...
| Parameter    | Attributes   | Description  |
| ------------ | ------------ | ------------ |
  |**`note`**|Type: number<br />Default: <br />mandatory|The note(s) to play. The notes can be specified by using a MIDI note number (0-127), a note name (e.g. C3, G#4, F-1, Db7), a {@link Note} object or an array of the previous types. When using a note name, octave range must be between -1 and 9. The lowest note is C-1 (MIDI note number 0) and the highest note is G9 (MIDI note number 127).|
  |**`options`**|Type: Object<br />Default: {}<br />optional||
  |**`options.channels`**|Type: number<br />Default: &quot;all&quot;<br />optional|The MIDI channel number (between `1` and `16`) or an array of channel numbers to play the note on. The special value `"all"` can also be used to use all channels (default).|
  |**`options.duration`**|Type: number<br />Default: <br />optional|The number of milliseconds (integer) after which a **note off** message will be scheduled. If left undefined, only a **note on** message is sent.|
  |**`options.rawValue`**|Type: boolean<br />Default: false<br />optional|Controls whether the attack and release velocities are set using integers between `0` and `127` (`true`) or a decimal number between `0` and `1` (`false`, default).|
  |**`options.release`**|Type: number<br />Default: 0.5<br />optional|The velocity at which to release the note (between `0` and `1`). If the `rawValue` option is `true`, the value should be specified as an integer between `0` and `127`. An invalid velocity value will silently trigger the default of `0.5`. This is only used with the **note off** event triggered when `options.duration` is set.|
  |**`options.time`**|Type: number<br />Default: <br />optional|If `time` is a string prefixed with `"+"` and followed by a number, the message will be delayed by that many milliseconds. If the value is a number (DOMHighResTimeStamp), the operation will be scheduled for that time. If `time` is omitted, or in the past, the operation will be carried out as soon as possible.|
  |**`options.attack`**|Type: number<br />Default: 0.5<br />optional|The attack velocity to use when playing the note (between `0` and `1`). If the `rawValue` option is `true`, the value should be specified as an integer between `0` and `127`. An invalid velocity value will silently trigger the default of `0.5`.|
...
| Parameter    | Attributes   | Description  |
| ------------ | ------------ | ------------ |
  |**`message`**|Type: Array.&lt;number&gt;<br />Default: <br />mandatory|An array of 8bit unsigned integers, a `Uint8Array` object (not available in Node.js) containing the message bytes or a `Message` object.|
  |**`options`**|Type: Object<br />Default: {}<br />optional||
...
| Parameter    | Attributes   | Description  |
| ------------ | ------------ | ------------ |
  |**`command`**|Type: number<br />Default: <br />mandatory|The numerical identifier of the channel mode message (integer between 120-127) or its name as a string.|
  |**`value`**|Type: number<br />Default: <br />optional|The value to send (integer between 0-127).|
  |**`options`**|Type: Object<br />Default: {}<br />optional||
  |**`options.channels`**|Type: number<br />Default: &quot;all&quot;<br />optional|The MIDI channel number (between `1` and `16`) or an array of channel numbers to use. The special value `"all"` can also be used to use all channels (default).|
  |**`options.time`**|Type: number<br />Default: <br />optional|If `time` is a string prefixed with `"+"` and followed by a number, the message will be delayed by that many milliseconds. If the value is a number (DOMHighResTimeStamp), the operation will be scheduled for that time. If `time` is omitted, or in the past, the operation will be carried out as soon as possible.|
...
| Parameter    | Attributes   | Description  |
| ------------ | ------------ | ------------ |
  |**`controller`**|Type: number<br />Default: <br />mandatory|The MIDI controller name or number (0-127).|
  |**`value`**|Type: number<br />Default: 0<br />optional|The value to send (0-127).|
  |**`options`**|Type: Object<br />Default: {}<br />optional||
  |**`options.channels`**|Type: number<br />Default: &quot;all&quot;<br />optional|The MIDI channel number (between `1` and `16`) or an array of channel numbers to use. The special value `"all"` can also be used to use all channels (default).|
  |**`options.time`**|Type: number<br />Default: <br />optional|If `time` is a string prefixed with `"+"` and followed by a number, the message will be delayed by that many milliseconds. If the value is a number (DOMHighResTimeStamp), the operation will be scheduled for that time. If `time` is omitted, or in the past, the operation will be carried out as soon as possible.|
...
| ------------ | ------------ | ------------ |
  ...
  |**`options`**|Type: Object<br />Default: {}<br />optional||
  |**`options.channels`**|Type: number<br />Default: &quot;all&quot;<br />optional|The MIDI channel number (between `1` and `16`) or an array of channel numbers to use. The special value `"all"` can also be used to use all channels (default).|
  |**`options.rawValue`**|Type: boolean<br />Default: false<br />optional|Controls whether the release velocity is set using integers between `0` and `127` (`true`) or a decimal number between `0` and `1` (`false`, default).|
  |**`options.time`**|Type: number<br />Default: <br />optional|If `time` is a string prefixed with `"+"` and followed by a number, the message will be delayed by that many milliseconds. If the value is a number (DOMHighResTimeStamp), the operation will be scheduled for that time. If `time` is omitted, or in the past, the operation will be carried out as soon as possible.|
  |**`options.release`**|Type: number<br />Default: 0.5<br />optional|The velocity at which to release the note (between `0` and `1`). If the `rawValue` option is `true`, the value should be specified as an integer between `0` and `127`. An invalid velocity value will silently trigger the default of `0.5`.|
...
| ------------ | ------------ | ------------ |
  ...
  |**`options`**|Type: Object<br />Default: {}<br />optional||
  |**`options.channels`**|Type: number<br />Default: &quot;all&quot;<br />optional|The MIDI channel number (between `1` and `16`) or an array of channel numbers to use. The special value `"all"` can also be used to use all channels (default).|
  |**`options.rawValue`**|Type: boolean<br />Default: false<br />optional|Controls whether the attack velocity is set using integers between `0` and `127` (`true`) or a decimal number between `0` and `1` (`false`, default).|
  |**`options.time`**|Type: number<br />Default: <br />optional|If `time` is a string prefixed with `"+"` and followed by a number, the message will be delayed by that many milliseconds. If the value is a number (DOMHighResTimeStamp), the operation will be scheduled for that time. If `time` is omitted, or in the past, the operation will be carried out as soon as possible.|
  |**`options.attack`**|Type: number<br />Default: 0.5<br />optional|The velocity at which to play the note (between `0` and `1`). If the `rawValue` option is `true`, the value should be specified as an integer between `0` and `127`. An invalid velocity value will silently trigger the default of `0.5`.|
...
| Parameter    | Attributes   | Description  |
| ------------ | ------------ | ------------ |
  |**`manufacturer`**|Type: number<br />Default: <br />mandatory|An unsigned integer or an array of three unsigned integers between 0 and 127 that identify the targeted manufacturer. The *MIDI Manufacturers Association* maintains a full list of [Manufacturer ID Numbers](https://www.midi.org/specifications-old/item/manufacturer-id-numbers) .|
  |**`data`**|Type: Array.&lt;number&gt;<br />Default: []<br />optional|A Uint8Array or an array of unsigned integers between 0 and 127. This is the data you wish to transfer.|
  |**`options`**|Type: Object<br />Default: {}<br />optional||
  |**`options.time`**|Type: number<br />Default: <br />optional|If `time` is a string prefixed with `"+"` and followed by a number, the message will be delayed by that many milliseconds. If the value is a number (DOMHighResTimeStamp), the operation will be scheduled for that time. If `time` is omitted, or in the past, the operation will be carried out as soon as possible.|
...
| Parameter    | Attributes   | Description  |
| ------------ | ------------ | ------------ |
  |**`value`**|Type: number<br />Default: <br />mandatory|The quarter frame message content (integer between 0 and 127).|
  |**`options`**|Type: Object<br />Default: {}<br />optional||
  |**`options.time`**|Type: number<br />Default: <br />optional|If `time` is a string prefixed with `"+"` and followed by a number, the message will be delayed by that many milliseconds. If the value is a number (DOMHighResTimeStamp), the operation will be scheduled for that time. If `time` is omitted, or in the past, the operation will be carried out as soon as possible.|
...
| Parameter    | Attributes   | Description  |
| ------------ | ------------ | ------------ |
  |**`pressure`**|Type: number<br />Default: 0.5<br />optional|The pressure level (between 0 and 1). An invalid pressure value will silently trigger the default behaviour. If the `rawValue` option is set to `true`, the pressure can be defined by using an integer between 0 and 127.|
  |**`options`**|Type: Object<br />Default: {}<br />optional||
  |**`options.channels`**|Type: number<br />Default: &quot;all&quot;<br />optional|The MIDI channel number (between `1` and `16`) or an array of channel numbers to use. The special value `"all"` can also be used to use all channels (default).|
  |**`options.rawValue`**|Type: boolean<br />Default: false<br />optional|A boolean indicating whether the value should be considered a float between 0 and 1.0 (default) or a raw integer between 0 and 127.|
  |**`options.time`**|Type: number<br />Default: <br />optional|If `time` is a string prefixed with `"+"` and followed by a number, the message will be delayed by that many milliseconds. If the value is a number (DOMHighResTimeStamp), the operation will be scheduled for that time. If `time` is omitted, or in the past, the operation will be carried out as soon as possible.|
...
| Parameter    | Attributes   | Description  |
| ------------ | ------------ | ------------ |
  |**`note`**|Type: number<br />Default: <br />mandatory|The note for which you are sending an aftertouch value. The notes can be specified in one of two ways. The first way is by using the MIDI note number (an integer between 0 and 127). The second way is by using the note name followed by the octave (C3, G#4, F-1, Db7). The octave range should be between -1 and 9. The lowest note is C-1 (MIDI note number 0) and the highest note is G9 (MIDI note number 127). It is also possible to use an array of note names and/or numbers.|
  |**`pressure`**|Type: number<br />Default: 0.5<br />optional|The pressure level (between 0 and 1). An invalid pressure value will silently trigger the default behaviour. If the `rawValue` option is set to `true`, the pressure can be defined by using an integer between 0 and 127.|
  |**`options`**|Type: Object<br />Default: {}<br />optional||
  |**`options.channels`**|Type: number<br />Default: &quot;all&quot;<br />optional|The MIDI channel number (between `1` and `16`) or an array of channel numbers to use. The special value `"all"` can also be used to use all channels (default).|
  |**`options.rawValue`**|Type: boolean<br />Default: false<br />optional|A boolean indicating whether the value should be considered a float between 0 and 1.0 (default) or a raw integer between 0 and 127.|
...
| Parameter    | Attributes   | Description  |
| ------------ | ------------ | ------------ |
  |**`state`**|Type: boolean<br />Default: false<br />optional|Whether to activate local control (`true`) or disable it (`false`).|
  |**`options`**|Type: Object<br />Default: {}<br />optional||
  |**`options.channels`**|Type: number<br />Default: &quot;all&quot;<br />optional|The MIDI channel number (between `1` and `16`) or an array of channel numbers to use. The special value `"all"` can also be used to use all channels (default).|
  |**`options.time`**|Type: number<br />Default: <br />optional|If `time` is a string prefixed with `"+"` and followed by a number, the message will be delayed by that many milliseconds. If the value is a number (DOMHighResTimeStamp), the operation will be scheduled for that time. If `time` is omitted, or in the past, the operation will be carried out as soon as possible.|
...
| Parameter    | Attributes   | Description  |
| ------------ | ------------ | ------------ |
  |**`value`**|Type: number<br />Default: 0.0<br />optional|The desired decimal adjustment value in semitones (-65 < x < 64)|
  |**`options`**|Type: Object<br />Default: {}<br />optional||
  |**`options.channels`**|Type: number<br />Default: &quot;all&quot;<br />optional|The MIDI channel number (between `1` and `16`) or an array of channel numbers to use. The special value `"all"` can also be used to use all channels (default).|
  |**`options.time`**|Type: number<br />Default: <br />optional|If `time` is a string prefixed with `"+"` and followed by a number, the message will be delayed by that many milliseconds. If the value is a number (DOMHighResTimeStamp), the operation will be scheduled for that time. If `time` is omitted, or in the past, the operation will be carried out as soon as possible.|
...
| Parameter    | Attributes   | Description  |
| ------------ | ------------ | ------------ |
  |**`semitones`**|Type: number<br />Default: 0<br />optional|The desired adjustment value in semitones (integer between 0 and 127).|
  |**`cents`**|Type: number<br />Default: 0<br />optional|The desired adjustment value in cents (integer between 0 and 127).|
  |**`options`**|Type: Object<br />Default: {}<br />optional||
  |**`options.channels`**|Type: number<br />Default: &quot;all&quot;<br />optional|The MIDI channel number (between `1` and `16`) or an array of channel numbers to use. The special value `"all"` can also be used to use all channels (default).|
  |**`options.time`**|Type: number<br />Default: <br />optional|If `time` is a string prefixed with `"+"` and followed by a number, the message will be delayed by that many milliseconds. If the value is a number (DOMHighResTimeStamp), the operation will be scheduled for that time. If `time` is omitted, or in the past, the operation will be carried out as soon as possible.|
...
| Parameter    | Attributes   | Description  |
| ------------ | ------------ | ------------ |
  |**`parameter`**|Type: Array.&lt;number&gt;<br />Default: <br />mandatory|A two-position array specifying the two control bytes (0x63, 0x62) that identify the non-registered parameter.|
  |**`data`**|Type: number<br />Default: []<br />optional|An integer or an array of integers with a length of 1 or 2 specifying the desired data.|
  |**`options`**|Type: Object<br />Default: {}<br />optional||
  |**`options.channels`**|Type: number<br />Default: &quot;all&quot;<br />optional|The MIDI channel number (between `1` and `16`) or an array of channel numbers to use. The special value `"all"` can also be used to use all channels (default).|
  |**`options.time`**|Type: number<br />Default: <br />optional|If `time` is a string prefixed with `"+"` and followed by a number, the message will be delayed by that many milliseconds. If the value is a number (DOMHighResTimeStamp), the operation will be scheduled for that time. If `time` is omitted, or in the past, the operation will be carried out as soon as possible.|
...
| Parameter    | Attributes   | Description  |
| ------------ | ------------ | ------------ |
  |**`state`**|Type: boolean<br />Default: <br />optional|Whether to activate OMNI mode (`true`) or not (`false`).|
  |**`options`**|Type: Object<br />Default: {}<br />optional||
  |**`options.channels`**|Type: number<br />Default: &quot;all&quot;<br />optional|The MIDI channel number (between `1` and `16`) or an array of channel numbers to use. The special value `"all"` can also be used to use all channels (default).|
  |**`options.time`**|Type: number<br />Default: <br />optional|If `time` is a string prefixed with `"+"` and followed by a number, the message will be delayed by that many milliseconds. If the value is a number (DOMHighResTimeStamp), the operation will be scheduled for that time. If `time` is omitted, or in the past, the operation will be carried out as soon as possible.|
...
| Parameter    | Attributes   | Description  |
| ------------ | ------------ | ------------ |
  |**`semitones`**|Type: number<br />Default: <br />mandatory|The desired adjustment value in semitones (between 0 and 127). While nothing imposes that in the specification, it is very common for manufacturers to limit the range to 2 octaves (-12 semitones to 12 semitones).|
  |**`cents`**|Type: number<br />Default: 0<br />optional|The desired adjustment value in cents (integer between 0-127).|
  |**`options`**|Type: Object<br />Default: {}<br />optional||
  |**`options.channels`**|Type: number<br />Default: &quot;all&quot;<br />optional|The MIDI channel number (between `1` and `16`) or an array of channel numbers to use. The special value `"all"` can also be used to use all channels (default).|
  |**`options.time`**|Type: number<br />Default: <br />optional|If `time` is a string prefixed with `"+"` and followed by a number, the message will be delayed by that many milliseconds. If the value is a number (DOMHighResTimeStamp), the operation will be scheduled for that time. If `time` is omitted, or in the past, the operation will be carried out as soon as possible.|
...
| Parameter    | Attributes   | Description  |
| ------------ | ------------ | ------------ |
  |**`mode`**|Type: string<br />Default: <br />mandatory|The mode to use: `"mono"` or `"poly"`.|
  |**`options`**|Type: Object<br />Default: {}<br />optional||
  |**`options.channels`**|Type: number<br />Default: &quot;all&quot;<br />optional|The MIDI channel number (between `1` and `16`) or an array of channel numbers to use. The special value `"all"` can also be used to use all channels (default).|
  |**`options.time`**|Type: number<br />Default: <br />optional|If `time` is a string prefixed with `"+"` and followed by a number, the message will be delayed by that many milliseconds. If the value is a number (DOMHighResTimeStamp), the operation will be scheduled for that time. If `time` is omitted, or in the past, the operation will be carried out as soon as possible.|
...
| Parameter    | Attributes   | Description  |
| ------------ | ------------ | ------------ |
  |**`program`**|Type: number<br />Default: 1<br />optional|The MIDI patch (program) number (1-128)|
  |**`options`**|Type: Object<br />Default: {}<br />optional||
  |**`options.channels`**|Type: number<br />Default: &quot;all&quot;<br />optional|The MIDI channel number (between `1` and `16`) or an array of channel numbers to use. The special value `"all"` can also be used to use all channels (default).|
  |**`options.time`**|Type: number<br />Default: <br />optional|If `time` is a string prefixed with `"+"` and followed by a number, the message will be delayed by that many milliseconds. If the value is a number (DOMHighResTimeStamp), the operation will be scheduled for that time. If `time` is omitted, or in the past, the operation will be carried out as soon as possible.|
...
| Parameter    | Attributes   | Description  |
| ------------ | ------------ | ------------ |
  |**`parameter`**|Type: string<br />Default: <br />mandatory|A string identifying the parameter's name (see above) or a two-position array specifying the two control bytes (e.g. `[0x65, 0x64]`) that identify the registered parameter.|
  |**`data`**|Type: number<br />Default: []<br />optional|A single integer or an array of integers with a maximum length of 2 specifying the desired data.|
  |**`options`**|Type: Object<br />Default: {}<br />optional||
  |**`options.channels`**|Type: number<br />Default: &quot;all&quot;<br />optional|The MIDI channel number (between `1` and `16`) or an array of channel numbers to use. The special value `"all"` can also be used to use all channels (default).|
  |**`options.time`**|Type: number<br />Default: <br />optional|If `time` is a string prefixed with `"+"` and followed by a number, the message will be delayed by that many milliseconds. If the value is a number (DOMHighResTimeStamp), the operation will be scheduled for that time. If `time` is omitted, or in the past, the operation will be carried out as soon as possible.|
...
| Parameter    | Attributes   | Description  |
| ------------ | ------------ | ------------ |
  |**`value`**|Type: number<br />Default: <br />mandatory|The number of the song to select (integer between 1 and 128).|
  |**`options`**|Type: Object<br />Default: {}<br />optional||
  |**`options.time`**|Type: number<br />Default: <br />optional|If `time` is a string prefixed with `"+"` and followed by a number, the message will be delayed by that many milliseconds. If the value is a number (DOMHighResTimeStamp), the operation will be scheduled for that time. If `time` is omitted, or in the past, the operation will be carried out as soon as possible.|
...
| Parameter    | Attributes   | Description  |
| ------------ | ------------ | ------------ |
  |**`value`**|Type: number<br />Default: 0<br />optional|The MIDI beat to cue to (integer between 0 and 16383).|
  |**`options`**|Type: Object<br />Default: {}<br />optional||
  |**`options.time`**|Type: number<br />Default: <br />optional|If `time` is a string prefixed with `"+"` and followed by a number, the message will be delayed by that many milliseconds. If the value is a number (DOMHighResTimeStamp), the operation will be scheduled for that time. If `time` is omitted, or in the past, the operation will be carried out as soon as possible.|
...
| Parameter    | Attributes   | Description  |
| ------------ | ------------ | ------------ |
  |**`value`**|Type: number<br />Default: <br />mandatory|The desired tuning bank (1-128).|
  |**`options`**|Type: Object<br />Default: {}<br />optional||
  |**`options.channels`**|Type: number<br />Default: &quot;all&quot;<br />optional|The MIDI channel number (between `1` and `16`) or an array of channel numbers to use. The special value `"all"` can also be used to use all channels (default).|
  |**`options.time`**|Type: number<br />Default: <br />optional|If `time` is a string prefixed with `"+"` and followed by a number, the message will be delayed by that many milliseconds. If the value is a number (DOMHighResTimeStamp), the operation will be scheduled for that time. If `time` is omitted, or in the past, the operation will be carried out as soon as possible.|
...
| Parameter    | Attributes   | Description  |
| ------------ | ------------ | ------------ |
  |**`value`**|Type: number<br />Default: <br />mandatory|The desired tuning program (1-128).|
  |**`options`**|Type: Object<br />Default: {}<br />optional||
  |**`options.channels`**|Type: number<br />Default: &quot;all&quot;<br />optional|The MIDI channel number (between `1` and `16`) or an array of channel numbers to use. The special value `"all"` can also be used to use all channels (default).|
  |**`options.time`**|Type: number<br />Default: <br />optional|If `time` is a string prefixed with `"+"` and followed by a number, the message will be delayed by that many milliseconds. If the value is a number (DOMHighResTimeStamp), the operation will be scheduled for that time. If `time` is omitted, or in the past, the operation will be carried out as soon as possible.|
...
| Parameter    | Attributes   | Description  |
| ------------ | ------------ | ------------ |
  |**`note`**|Type: <br />Default: <br />mandatory||
  |**`options`**|Type: <br />Default: <br />mandatory||
