...
| ------------ | ------------ | ------------ |
|**`parameter`**  : String|<br />Default: |A string identifying the parameter's name (see above) or a two-position array specifying the two control bytes (0x65, 0x64) that identify the registered parameter.|
|[ **`options`** ]  : Object|<br />Default: {}||
|[ **`options.time`** ]  : number|<br />Default: |If `time` is a string prefixed with `"+"` and followed by a number, the message will be delayed by that many milliseconds. If the value is a number, the operation will be scheduled for that time. The current time can be retrieved with [WebMidi.time]{@link WebMidi#time}. If `options.time` is omitted, or in the past, the operation will be carried out as soon as possible.|
...
| Parameter    | Default      | Description  |
| ------------ | ------------ | ------------ |
|**`note`**  : number|<br />Default: |The note(s) to play. The notes can be specified by using a MIDI note number (0-127), a note name (e.g. C3, G#4, F-1, Db7), a {@link Note} object or an array of the previous types. When using a note name, octave range must be between -1 and 9. The lowest note is C-1 (MIDI note number 0) and the highest note is G9 (MIDI note number 127).|
|[ **`options`** ]  : Object|<br />Default: {}||
|[ **`options.duration`** ]  : number|<br />Default: |A positive number larger than 0 representing the number of milliseconds to wait before sending a **note off** message. If invalid or left undefined, only a **note on** message will be sent.|
|[ **`options.attack`** ]  : number|<br />Default: 0.5|The velocity at which to play the note (between `0` and `1`). If the `rawAttack` option is also defined, it will have priority. An invalid velocity value will silently trigger the default of `0.5`.|
|[ **`options.rawAttack`** ]  : number|<br />Default: 0.5|The attack velocity at which to play the note (between `0` and `127`). This has priority over the `attack` property. An invalid velocity value will silently trigger the default of `0.5`.|
...
|[ **`options.rawRelease`** ]  : number|<br />Default: 0.5|The velocity at which to release the note (between `0` and `127`). This has priority over the `release` property. An invalid velocity value will silently trigger the default of `0.5`. This is only used with the **note off** event triggered when `options.duration` is set.|
|[ **`options.time`** ]  : number|<br />Default: |If `time` is a string prefixed with `"+"` and followed by a number, the message will be delayed by that many milliseconds. If the value is a number, the operation will be scheduled for that time. The current time can be retrieved with [WebMidi.time]{@link WebMidi#time}. If `options.time` is omitted, or in the past, the operation will be carried out as soon as possible.|
...
| Parameter    | Default      | Description  |
| ------------ | ------------ | ------------ |
|**`message`**  : Array.&lt;number&gt;|<br />Default: |An array of 8bit unsigned integers, a `Uint8Array` object (not available in Node.js) containing the message bytes or a `Message` object.|
|[ **`options`** ]  : Object|<br />Default: {}||
|[ **`options.time`** ]  : number|<br />Default: |If `time` is a string prefixed with `"+"` and followed by a number, the message will be delayed by that many milliseconds. If the value is a positive number ([DOMHighResTimeStamp]{@link https://developer.mozilla.org/docs/Web/API/DOMHighResTimeStamp}), the operation will be scheduled for that point time. If `time` is omitted, or in the past, the operation will be carried out as soon as possible.|
...
| Parameter    | Default      | Description  |
| ------------ | ------------ | ------------ |
|**`command`**  : number|<br />Default: |The numerical identifier of the channel mode message (integer between 120-127) or its name as a string.|
|**`value`**  : number|<br />Default: |The value to send (integer between 0-127).|
|[ **`options`** ]  : Object|<br />Default: {}||
|[ **`options.time`** ]  : number|<br />Default: |If `time` is a string prefixed with `"+"` and followed by a number, the message will be delayed by that many milliseconds. If the value is a number, the operation will be scheduled for that time. The current time can be retrieved with [WebMidi.time]{@link WebMidi#time}. If `options.time` is omitted, or in the past, the operation will be carried out as soon as possible.|
...
| Parameter    | Default      | Description  |
| ------------ | ------------ | ------------ |
|**`controller`**  : number|<br />Default: |The MIDI controller name or number (0-127).|
|**`value`**  : number|<br />Default: |The value to send (0-127). You can also use a two-position array for controllers 0 to 31. In this scenario, the first value will be sent as usual and the second calue will be sent to the matching LSB controller (which is obtained by adding 32 to the first controller)|
|[ **`options`** ]  : Object|<br />Default: {}||
|[ **`options.time`** ]  : number|<br />Default: |If `time` is a string prefixed with `"+"` and followed by a number, the message will be delayed by that many milliseconds. If the value is a number, the operation will be scheduled for that time. The current time can be retrieved with [WebMidi.time]{@link WebMidi#time}. If `options.time` is omitted, or in the past, the operation will be carried out as soon as possible.|
...
| Parameter    | Default      | Description  |
| ------------ | ------------ | ------------ |
|**`note`**  : number|<br />Default: |The note(s) to stop. The notes can be specified by using a MIDI note number (0-127), a note name (e.g. C3, G#4, F-1, Db7), a {@link Note} object or an array of the previous types. When using a note name, octave range must be between -1 and 9. The lowest note is C-1 (MIDI note number 0) and the highest note is G9 (MIDI note number 127).|
|[ **`options`** ]  : Object|<br />Default: {}||
|[ **`options.time`** ]  : number|<br />Default: |If `time` is a string prefixed with `"+"` and followed by a number, the message will be delayed by that many milliseconds. If the value is a number, the operation will be scheduled for that time. The current time can be retrieved with [WebMidi.time]{@link WebMidi#time}. If `options.time` is omitted, or in the past, the operation will be carried out as soon as possible.|
|[ **`options.release`** ]  : number|<br />Default: 0.5|The velocity at which to release the note (between `0` and `1`).  If the `rawRelease` option is also defined, `rawRelease` will have priority. An invalid velocity value will silently trigger the default of `0.5`.|
|[ **`options.rawRelease`** ]  : number|<br />Default: 64|The velocity at which to release the note (between `0` and `127`). If the `release` option is also defined, `rawRelease` will have priority. An invalid velocity value will silently trigger the default of `64`.|
...
| Parameter    | Default      | Description  |
| ------------ | ------------ | ------------ |
|**`note`**  : number|<br />Default: |The note(s) to play. The notes can be specified by using a MIDI note number (0-127), a note identifier (e.g. C3, G#4, F-1, Db7), a {@link Note} object or an array of the previous types.|
|[ **`options`** ]  : Object|<br />Default: {}||
|[ **`options.time`** ]  : number|<br />Default: |If `time` is a string prefixed with `"+"` and followed by a number, the message will be delayed by that many milliseconds. If the value is a number, the operation will be scheduled for that time. The current time can be retrieved with [WebMidi.time]{@link WebMidi#time}. If `options.time` is omitted, or in the past, the operation will be carried out as soon as possible.|
|[ **`options.attack`** ]  : number|<br />Default: 0.5|The velocity at which to play the note (between `0` and `1`).  If the `rawAttack` option is also defined, `rawAttack` will have priority. An invalid velocity value will silently trigger the default of `0.5`.|
|[ **`options.rawAttack`** ]  : number|<br />Default: 64|The velocity at which to release the note (between `0` and `127`). If the `attack` option is also defined, `rawAttack` will have priority. An invalid velocity value will silently trigger the default of `64`.|
...
| Parameter    | Default      | Description  |
| ------------ | ------------ | ------------ |
|[ **`pressure`** ]  : number|<br />Default: |The pressure level (between 0 and 1). If the `rawValue` option is set to `true`, the pressure can be defined by using an integer between 0 and 127.|
|[ **`options`** ]  : Object|<br />Default: {}||
|[ **`options.rawValue`** ]  : boolean|<br />Default: false|A boolean indicating whether the value should be considered a float between 0 and 1.0 (default) or a raw integer between 0 and 127.|
|[ **`options.time`** ]  : number|<br />Default: |If `time` is a string prefixed with `"+"` and followed by a number, the message will be delayed by that many milliseconds. If the value is a number, the operation will be scheduled for that time. The current time can be retrieved with [WebMidi.time]{@link WebMidi#time}. If `options.time` is omitted, or in the past, the operation will be carried out as soon as possible.|
...
| Parameter    | Default      | Description  |
| ------------ | ------------ | ------------ |
|**`target`**  : number|<br />Default: |The key(s) for which you are sending an aftertouch value. The notes can be specified by using a MIDI note number (0-127), a note identifier (e.g. C3, G#4, F-1, Db7), or an array of the previous types. When using a note identifier, the octave value will be offset by the combined value of `InputChannel.octaveOffset`, `Input.octaveOffset` and `WebMidi.octaveOffset` (if those values are not `0`). When using a key number, octaveOffset values are ignored.|
|[ **`pressure`** ]  : number|<br />Default: 0.5|The pressure level (between 0 and 1). An invalid pressure value will silently trigger the default behaviour. If the `rawValue` option is set to `true`, the pressure is defined by using an integer between 0 and 127.|
|[ **`options`** ]  : Object|<br />Default: {}||
|[ **`options.useRawValue`** ]  : boolean|<br />Default: false|A boolean indicating whether the value should be considered a float between 0 and 1.0 (default) or a raw integer between 0 and 127.|
|[ **`options.time`** ]  : number|<br />Default: |If `time` is a string prefixed with `"+"` and followed by a number, the message will be delayed by that many milliseconds. If the value is a number, the operation will be scheduled for that time. The current time can be retrieved with [WebMidi.time]{@link WebMidi#time}. If `options.time` is omitted, or in the past, the operation will be carried out as soon as possible.|
...
| Parameter    | Default      | Description  |
| ------------ | ------------ | ------------ |
|[ **`state`** ]  : boolean|<br />Default: false|Whether to activate local control (`true`) or disable it (`false`).|
|[ **`options`** ]  : Object|<br />Default: {}||
|[ **`options.time`** ]  : number|<br />Default: |If `time` is a string prefixed with `"+"` and followed by a number, the message will be delayed by that many milliseconds. If the value is a number, the operation will be scheduled for that time. The current time can be retrieved with [WebMidi.time]{@link WebMidi#time}. If `options.time` is omitted, or in the past, the operation will be carried out as soon as possible.|
...
| Parameter    | Default      | Description  |
| ------------ | ------------ | ------------ |
|[ **`value`** ]  : number|<br />Default: 0.0|The desired decimal adjustment value in semitones (-65 < x < 64)|
|[ **`options`** ]  : Object|<br />Default: {}||
|[ **`options.time`** ]  : number|<br />Default: |If `time` is a string prefixed with `"+"` and followed by a number, the message will be delayed by that many milliseconds. If the value is a number, the operation will be scheduled for that time. The current time can be retrieved with [WebMidi.time]{@link WebMidi#time}. If `options.time` is omitted, or in the past, the operation will be carried out as soon as possible.|
...
| Parameter    | Default      | Description  |
| ------------ | ------------ | ------------ |
|**`semitones`**  : number|<br />Default: |The desired adjustment value in semitones (integer between 0 and 127).|
|[ **`cents`** ]  : number|<br />Default: 0|The desired adjustment value in cents (integer between 0 and 127).|
|[ **`options`** ]  : Object|<br />Default: {}||
|[ **`options.time`** ]  : number|<br />Default: |If `time` is a string prefixed with `"+"` and followed by a number, the message will be delayed by that many milliseconds. If the value is a number, the operation will be scheduled for that time. The current time can be retrieved with [WebMidi.time]{@link WebMidi#time}. If `options.time` is omitted, or in the past, the operation will be carried out as soon as possible.|
...
| Parameter    | Default      | Description  |
| ------------ | ------------ | ------------ |
|**`parameter`**  : Array.&lt;number&gt;|<br />Default: |A two-position array specifying the two control bytes (0x63, 0x62) that identify the non-registered parameter.|
|[ **`data`** ]  : number|<br />Default: []|An integer or an array of integers with a length of 1 or 2 specifying the desired data.|
|[ **`options`** ]  : Object|<br />Default: {}||
|[ **`options.time`** ]  : number|<br />Default: |If `time` is a string prefixed with `"+"` and followed by a number, the message will be delayed by that many milliseconds. If the value is a number, the operation will be scheduled for that time. The current time can be retrieved with [WebMidi.time]{@link WebMidi#time}. If `options.time` is omitted, or in the past, the operation will be carried out as soon as possible.|
...
| Parameter    | Default      | Description  |
| ------------ | ------------ | ------------ |
|[ **`state`** ]  : boolean|<br />Default: true|Whether to activate OMNI mode (`true`) or not (`false`).|
|[ **`options`** ]  : Object|<br />Default: {}||
|[ **`options.time`** ]  : number|<br />Default: |If `time` is a string prefixed with `"+"` and followed by a number, the message will be delayed by that many milliseconds. If the value is a number, the operation will be scheduled for that time. The current time can be retrieved with [WebMidi.time]{@link WebMidi#time}. If `options.time` is omitted, or in the past, the operation will be carried out as soon as possible.|
...
|[ **`options`** ]  : Object|<br />Default: {}||
|[ **`options.rawValue`** ]  : boolean|<br />Default: false|A boolean indicating whether the value should be considered as a float between -1.0 and 1.0 (default) or as raw integer between 0 and 127 (or an array of 2 integers if using both MSB and LSB).|
|[ **`options.time`** ]  : number|<br />Default: |If `time` is a string prefixed with `"+"` and followed by a number, the message will be delayed by that many milliseconds. If the value is a number, the operation will be scheduled for that time. The current time can be retrieved with [WebMidi.time]{@link WebMidi#time}. If `options.time` is omitted, or in the past, the operation will be carried out as soon as possible.|
...
| Parameter    | Default      | Description  |
| ------------ | ------------ | ------------ |
|**`semitones`**  : number|<br />Default: |The desired adjustment value in semitones (between 0 and 127). While nothing imposes that in the specification, it is very common for manufacturers to limit the range to 2 octaves (-12 semitones to 12 semitones).|
|[ **`cents`** ]  : number|<br />Default: 0|The desired adjustment value in cents (integer between 0-127).|
|[ **`options`** ]  : Object|<br />Default: {}||
|[ **`options.time`** ]  : number|<br />Default: |If `time` is a string prefixed with `"+"` and followed by a number, the message will be delayed by that many milliseconds. If the value is a number, the operation will be scheduled for that time. The current time can be retrieved with [WebMidi.time]{@link WebMidi#time}. If `options.time` is omitted, or in the past, the operation will be carried out as soon as possible.|
...
| Parameter    | Default      | Description  |
| ------------ | ------------ | ------------ |
|[ **`mode`** ]  : string|<br />Default: poly|The mode to use: `"mono"` or `"poly"`.|
|[ **`options`** ]  : Object|<br />Default: {}||
|[ **`options.time`** ]  : number|<br />Default: |If `time` is a string prefixed with `"+"` and followed by a number, the message will be delayed by that many milliseconds. If the value is a number, the operation will be scheduled for that time. The current time can be retrieved with [WebMidi.time]{@link WebMidi#time}. If `options.time` is omitted, or in the past, the operation will be carried out as soon as possible.|
...
| Parameter    | Default      | Description  |
| ------------ | ------------ | ------------ |
|[ **`program`** ]  : number|<br />Default: 1|The MIDI patch (program) number (1-128)|
|[ **`options`** ]  : Object|<br />Default: {}||
|[ **`options.time`** ]  : number|<br />Default: |If `time` is a string prefixed with `"+"` and followed by a number, the message will be delayed by that many milliseconds. If the value is a number, the operation will be scheduled for that time. The current time can be retrieved with [WebMidi.time]{@link WebMidi#time}. If `options.time` is omitted, or in the past, the operation will be carried out as soon as possible.|
...
| Parameter    | Default      | Description  |
| ------------ | ------------ | ------------ |
|**`parameter`**  : string|<br />Default: |A string identifying the parameter's name (see above) or a two-position array specifying the two control bytes (e.g. `[0x65, 0x64]`) that identify the registered parameter.|
|[ **`data`** ]  : number|<br />Default: []|An single integer or an array of integers with a maximum length of 2 specifying the desired data.|
|[ **`options`** ]  : Object|<br />Default: {}||
|[ **`options.time`** ]  : number|<br />Default: |If `time` is a string prefixed with `"+"` and followed by a number, the message will be delayed by that many milliseconds. If the value is a number, the operation will be scheduled for that time. The current time can be retrieved with [WebMidi.time]{@link WebMidi#time}. If `options.time` is omitted, or in the past, the operation will be carried out as soon as possible.|
...
| Parameter    | Default      | Description  |
| ------------ | ------------ | ------------ |
|**`value`**  : number|<br />Default: |The desired tuning bank (1-128).|
|[ **`options`** ]  : Object|<br />Default: {}||
|[ **`options.time`** ]  : number|<br />Default: |If `time` is a string prefixed with `"+"` and followed by a number, the message will be delayed by that many milliseconds. If the value is a number, the operation will be scheduled for that time. The current time can be retrieved with [WebMidi.time]{@link WebMidi#time}. If `options.time` is omitted, or in the past, the operation will be carried out as soon as possible.|
...
| Parameter    | Default      | Description  |
| ------------ | ------------ | ------------ |
|**`value`**  : number|<br />Default: |The desired tuning program (1-128).|
|[ **`options`** ]  : Object|<br />Default: {}||
|[ **`options.time`** ]  : number|<br />Default: |If `time` is a string prefixed with `"+"` and followed by a number, the message will be delayed by that many milliseconds. If the value is a number, the operation will be scheduled for that time. The current time can be retrieved with [WebMidi.time]{@link WebMidi#time}. If `options.time` is omitted, or in the past, the operation will be carried out as soon as possible.|
