...
| ------------ | ------------ | ------------ |
  ...
  |**`options`**|Type: Object<br />Default: {}<br />optional||
  |**`options.duration`**|Type: number<br />Default: <br />optional|A positive number larger than 0 representing the number of milliseconds to wait before sending a **note off** message. If invalid or left undefined, only a **note on** message will be sent.|
  |**`options.attack`**|Type: number<br />Default: 0.5<br />optional|The velocity at which to play the note (between `0` and `1`). If the `rawAttack` option is also defined, it will have priority. An invalid velocity value will silently trigger the default of `0.5`.|
  |**`options.rawAttack`**|Type: number<br />Default: 0.5<br />optional|The attack velocity at which to play the note (between `0` and `127`). This has priority over the `attack` property. An invalid velocity value will silently trigger the default of `0.5`.|
...
| ------------ | ------------ | ------------ |
  ...
  |**`value`**|Type: number<br />Default: <br />mandatory|The value to send (integer between 0-127).|
  |**`options`**|Type: Object<br />Default: {}<br />optional||
  |**`options.time`**|Type: number<br />Default: <br />optional|If `time` is a string prefixed with `"+"` and followed by a number, the message will be delayed by that many milliseconds. If the value is a number, the operation will be scheduled for that time. The current time can be retrieved with [WebMidi.time]{@link WebMidi#time}. If `options.time` is omitted, or in the past, the operation will be carried out as soon as possible.|
...
| ------------ | ------------ | ------------ |
  ...
  |**`value`**|Type: number<br />Default: <br />mandatory|The value to send (0-127). You can also use a two-position array for controllers 0 to 31. In this scenario, the first value will be sent as usual and the second calue will be sent to the matching LSB controller (which is obtained by adding 32 to the first controller)|
  |**`options`**|Type: Object<br />Default: {}<br />optional||
  |**`options.time`**|Type: number<br />Default: <br />optional|If `time` is a string prefixed with `"+"` and followed by a number, the message will be delayed by that many milliseconds. If the value is a number, the operation will be scheduled for that time. The current time can be retrieved with [WebMidi.time]{@link WebMidi#time}. If `options.time` is omitted, or in the past, the operation will be carried out as soon as possible.|
...
| ------------ | ------------ | ------------ |
  ...
  |**`options`**|Type: Object<br />Default: {}<br />optional||
  |**`options.time`**|Type: number<br />Default: <br />optional|If `time` is a string prefixed with `"+"` and followed by a number, the message will be delayed by that many milliseconds. If the value is a number, the operation will be scheduled for that time. The current time can be retrieved with [WebMidi.time]{@link WebMidi#time}. If `options.time` is omitted, or in the past, the operation will be carried out as soon as possible.|
  |**`options.release`**|Type: number<br />Default: 0.5<br />optional|The velocity at which to release the note (between `0` and `1`).  If the `rawRelease` option is also defined, `rawRelease` will have priority. An invalid velocity value will silently trigger the default of `0.5`.|
  |**`options.rawRelease`**|Type: number<br />Default: 64<br />optional|The velocity at which to release the note (between `0` and `127`). If the `release` option is also defined, `rawRelease` will have priority. An invalid velocity value will silently trigger the default of `64`.|
...
| Parameter    | Attributes   | Description  |
| ------------ | ------------ | ------------ |
  |**`note`**|Type: number<br />Default: <br />mandatory|The note(s) to play. The notes can be specified by using a MIDI note number (0-127), a note identifier (e.g. C3, G#4, F-1, Db7), a {@link Note} object or an array of the previous types.|
  |**`options`**|Type: Object<br />Default: {}<br />optional||
  |**`options.time`**|Type: number<br />Default: <br />optional|If `time` is a string prefixed with `"+"` and followed by a number, the message will be delayed by that many milliseconds. If the value is a number, the operation will be scheduled for that time. The current time can be retrieved with [WebMidi.time]{@link WebMidi#time}. If `options.time` is omitted, or in the past, the operation will be carried out as soon as possible.|
  |**`options.attack`**|Type: number<br />Default: 0.5<br />optional|The velocity at which to play the note (between `0` and `1`).  If the `rawAttack` option is also defined, `rawAttack` will have priority. An invalid velocity value will silently trigger the default of `0.5`.|
  |**`options.rawAttack`**|Type: number<br />Default: 64<br />optional|The velocity at which to release the note (between `0` and `127`). If the `attack` option is also defined, `rawAttack` will have priority. An invalid velocity value will silently trigger the default of `64`.|
...
| Parameter    | Attributes   | Description  |
| ------------ | ------------ | ------------ |
  |**`pressure`**|Type: number<br />Default: <br />optional|The pressure level (between 0 and 1). If the `rawValue` option is set to `true`, the pressure can be defined by using an integer between 0 and 127.|
  |**`options`**|Type: Object<br />Default: {}<br />optional||
...
| Parameter    | Attributes   | Description  |
| ------------ | ------------ | ------------ |
  |**`target`**|Type: number<br />Default: <br />mandatory|The key(s) for which you are sending an aftertouch value. The notes can be specified by using a MIDI note number (0-127), a note identifier (e.g. C3, G#4, F-1, Db7), or an array of the previous types. When using a note identifier, the octave value will be offset by the combined value of `InputChannel.octaveOffset`, `Input.octaveOffset` and `WebMidi.octaveOffset` (if those values are not `0`). When using a key number, octaveOffset values are ignored.|
  |**`pressure`**|Type: number<br />Default: 0.5<br />optional|The pressure level (between 0 and 1). An invalid pressure value will silently trigger the default behaviour. If the `rawValue` option is set to `true`, the pressure is defined by using an integer between 0 and 127.|
  |**`options`**|Type: Object<br />Default: {}<br />optional||
  |**`options.useRawValue`**|Type: boolean<br />Default: false<br />optional|A boolean indicating whether the value should be considered a float between 0 and 1.0 (default) or a raw integer between 0 and 127.|
  |**`options.time`**|Type: number<br />Default: <br />optional|If `time` is a string prefixed with `"+"` and followed by a number, the message will be delayed by that many milliseconds. If the value is a number, the operation will be scheduled for that time. The current time can be retrieved with [WebMidi.time]{@link WebMidi#time}. If `options.time` is omitted, or in the past, the operation will be carried out as soon as possible.|
...
| Parameter    | Attributes   | Description  |
| ------------ | ------------ | ------------ |
  |**`semitones`**|Type: number<br />Default: <br />mandatory|The desired adjustment value in semitones (integer between 0 and 127).|
...
| Parameter    | Attributes   | Description  |
| ------------ | ------------ | ------------ |
  |**`state`**|Type: boolean<br />Default: true<br />optional|Whether to activate OMNI mode (`true`) or not (`false`).|
  |**`options`**|Type: Object<br />Default: {}<br />optional||
  |**`options.time`**|Type: number<br />Default: <br />optional|If `time` is a string prefixed with `"+"` and followed by a number, the message will be delayed by that many milliseconds. If the value is a number, the operation will be scheduled for that time. The current time can be retrieved with [WebMidi.time]{@link WebMidi#time}. If `options.time` is omitted, or in the past, the operation will be carried out as soon as possible.|
...
| Parameter    | Attributes   | Description  |
| ------------ | ------------ | ------------ |
  |**`mode`**|Type: string<br />Default: poly<br />optional|The mode to use: `"mono"` or `"poly"`.|
  |**`options`**|Type: Object<br />Default: {}<br />optional||
  |**`options.time`**|Type: number<br />Default: <br />optional|If `time` is a string prefixed with `"+"` and followed by a number, the message will be delayed by that many milliseconds. If the value is a number, the operation will be scheduled for that time. The current time can be retrieved with [WebMidi.time]{@link WebMidi#time}. If `options.time` is omitted, or in the past, the operation will be carried out as soon as possible.|
...
| ------------ | ------------ | ------------ |
  ...
  |**`data`**|Type: number<br />Default: []<br />optional|An single integer or an array of integers with a maximum length of 2 specifying the desired data.|
  |**`options`**|Type: Object<br />Default: {}<br />optional||
  |**`options.time`**|Type: number<br />Default: <br />optional|If `time` is a string prefixed with `"+"` and followed by a number, the message will be delayed by that many milliseconds. If the value is a number, the operation will be scheduled for that time. The current time can be retrieved with [WebMidi.time]{@link WebMidi#time}. If `options.time` is omitted, or in the past, the operation will be carried out as soon as possible.|
